...
public class Eje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eje);

        setTitle("Formulario Eje");//titulo de la pantalla

        //CONEXION DE VARIBLES CREADAS CON LOS OBJETOS CREADOS EN EL XML
        button_buscar = (Button) findViewById(R.id.btn_buscareje);//TOMANDO CONTROL DEL OBJETO XML
        button_agregar = (Button) findViewById(R.id.btn_agregareje);//TOMANDO CONTROL DEL OBJETO XML
        button_modificar = (Button) findViewById(R.id.btn_modificareje);//TOMANDO CONTROL DEL OBJETO XML
        button_eliminar = (Button) findViewById(R.id.btn_eliminareje);//TOMANDO CONTROL DEL OBJETO XML
        editText_id = (EditText) findViewById(R.id.et_ideje);//TOMANDO CONTROL DEL OBJETO XML
        editText_descripcion = (EditText) findViewById(R.id.et_descripcioneje);//TOMANDO CONTROL DEL OBJETO XML
        ...
        button_agregar.setOnClickListener(new View.OnClickListener() {//INICIA EL METODO ACCION DENTRO DEL BOTON INDICADO
            ...
            public void onClick(View v) {
                ...
                String registro = dataBaseAccess.setInsertEje(id, des);//GUARDAMOS EL MENSAJE DE INSERTADO O NO
        ...
        button_buscar.setOnClickListener(new View.OnClickListener() {//INICIA EL METODO ACCION DENTRO DEL BOTON INDICADO
            ...
            public void onClick(View v) {
                ...
                ObjEje ej = dataBaseAccess.SearchEje(idb);//GUARDAMOS EL MENSAJE DE INSERTADO O NO

                if (ej.getId() != 0) {//SI NO SE CUMPLE NINGUNAS DE LAS ANTERIORES CONDICIONES

                    System.out.println("EN EJE: "+ej.getId());
                    di = ej.getId();//se guarda el valor para usarlo dentro del boton modificar

                    editText_descripcion.setText(ej.getDescripcion());
        ...
        button_modificar.setOnClickListener(new View.OnClickListener() {//INICIA EL METODO ACCION DENTRO DEL BOTON INDICADO
            ...
            public void onClick(View v) {
                ...
                String registro = dataBaseAccess.ModificarEje(idm, idn, descripcion);//GUARDAMOS EL MENSAJE DE INSERTADO O NO
        ...
        button_eliminar.setOnClickListener(new View.OnClickListener() {//INICIA EL METODO ACCION DENTRO DEL BOTON INDICADO
            ...
            public void onClick(View v) {
                ...
                String eliminacion = dataBaseAccess.EliminarEje(ide);//GUARDAMOS EL MENSAJE DE INSERTADO O NO
